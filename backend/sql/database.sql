-- MedVet Connect Database Schema
-- Sistema de adoção e campanhas veterinárias

CREATE DATABASE IF NOT EXISTS medvet_connect;
USE medvet_connect;
...
-- Tabela de histórico médico/vacinal
